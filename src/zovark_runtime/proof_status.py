...
PROOF_CHAIN_CHECKLIST = [
    ...
    },
    {
        ...
        "source_hashes": {
            "contracts/replay-compatibility.yaml": "6be9b34ac35dffde387acb46abfefe2bd7a94ffcf8512c28585f6648b4040e98",
            "contracts/replay-compatibility.schema.json": "c5b0f03ae238a3fe34e63e094c4112e1fffb4187b217d85d94ace01e4fabcbb1",
        },
    },
    {
    ...
    },
    {
        ...
        "authority_required": "architecture issue #55 must define canonical replay failure-code/failure-record authority before runtime claims coverage mapping",
    ...
    },
    {
        ...
        "milestone_or_queue_position": "after architecture issue #55 defines canonical failure-code/failure-record authority",
        "architecture_authority": [
            "ADR-0047",
            "INV-036",
            "https://github.com/7inaydas-cmyk/zovark-architecture/issues/55",
        ],
        "authority_required": "architecture issue #55 must define explicit failure-record or failure-code contract authority before runtime can persist these as canonical proof artifacts",
        "completion_note": "runtime is not claiming proof-loop completion",
    },
    {
