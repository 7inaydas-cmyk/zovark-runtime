...
SCHEMA = CONTRACTS / "verdict_input.schema.json"
FIXTURE = FIXTURES / "verdict_input_minimal.json"


def test_verdict_input_fixture_validates_against_canonical_schema() -> None:
    ...
    assert fixture["investigation_id"] == "33333333-3333-4333-8333-333333333333"
    assert fixture["alert_envelope"]["scanner_type"] == "edr"
    assert fixture["decoding_params"]["seed_policy"] == "no_seed"
    print("VERDICT_INPUT_FIXTURE_SCHEMA_OK")


def test_verdict_input_fixture_rejects_extra_fields() -> None:
    fixture = _load_json(FIXTURE)
...
def test_verdict_input_rejects_forbidden_nondeterministic_field_names(field_name: str) -> None:
    fixture = _load_json(FIXTURE)
    invalid = copy.deepcopy(fixture)
...
def test_verdict_input_fixture_contains_no_forbidden_payload_markers() -> None:
    fixture = _load_json(FIXTURE)
